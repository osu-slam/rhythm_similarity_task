...
function beta_draw_GUI(mode, varargin)
...
edge = (one9thX - 2*ee)/2; % Top and bottom edge of likert squares
...
labelRect([1, 3], 1) = labelRect([1, 3], 1) + 3*ee;
labelRect([1, 3], 2) = labelRect([1, 3], 2) - 3*ee;
...
if strcmp(mode, 'first')
    ...
    DrawFormattedText(wPtr, 'least\nsimilar', 'center', 'center', [0 0 0], [], [], [], [], [], labelRect(:, 1)');
